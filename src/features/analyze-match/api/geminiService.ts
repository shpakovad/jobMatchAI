...
export const generateMatchAnalysis = async (
      ...
      Структура JSON, которую ты ОБЯЗАН вернуть:
  {
    ...
    "suggestedResumeBullets": [
      "Сильная формулировка (bullet point) для раздела 'Опыт работы', написанная по методологии XYZ (Достиг X, измерив через Y, сделав Z), адаптированная под требования вакансии",
      "Еще одна сильная формулировка достижений..."
    ],
