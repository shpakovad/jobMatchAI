...
function Toast({ className, ...props }: ToastPrimitive.Root.Props) {
  return (
    <ToastPrimitive.Root
      data-slot="toast"
      className={cn(
        "group/toast bg-popover text-popover-foreground focus-visible:border-ring focus-visible:ring-ring/50 pointer-events-auto absolute bottom-0 right-0 z-[calc(1000-var(--toast-index))] w-full origin-bottom select-none rounded-2xl border border-b border-l border-r border-t border-white/25 shadow-lg outline-none will-change-transform focus-visible:ring-[3px]",
...
function ToastClose({
  ...
  return (
    <ToastPrimitive.Close
      ...
      render={render}
      className={cn(
        "hover:text-foreground relative shrink-0 text-muted-foreground after:absolute after:-inset-2 after:content-['']",
        className,
      )}
      {...props}
    >
